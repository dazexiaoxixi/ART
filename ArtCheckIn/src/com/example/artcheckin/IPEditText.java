...
public class IPEditText extends LinearLayout {
	...
	public IPEditText(Context context, AttributeSet attrs) {
		...
		String ip[] = DefineVar.ServerIP.split("\\.");
		if(ip.length == 4)
		{
...
//					mThirdIP.setSelection(mPreferences.getInt("IP_THIRD", 0));
	...
	public void setText(String textStr) {
		...
		System.out.println("-----setText input:"+str.length);
		if(str.length==4){
			mFirstIP.setText(str[0]);
			mSecondIP.setText(str[1]);
			mThirdIP.setText(str[2]);
			mFourthIP.setText(str[3]);
		}
	}
